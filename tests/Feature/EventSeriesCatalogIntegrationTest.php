...
class EventSeriesCatalogIntegrationTest extends TestCase
{
    ...
    public function test_manual_duplicate_keeps_logical_series_but_gets_independent_schedule_and_inventory(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-09-05 12:00:00', 'America/Sao_Paulo'));
        $app = $this->applicationFixture('cutinapp', ['name' => 'Cutinapp', 'is_active' => true]);
    ...
    public function test_all_active_catalog_import_uses_catalog_stock_and_event_capacity_fallback(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-09-05 12:00:00', 'America/Sao_Paulo'));
        $app = $this->applicationFixture('cutinapp', ['name' => 'Cutinapp', 'is_active' => true]);
