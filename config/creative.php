...
return [
    ...
    'cloudflare' => [
        ...
        'catalog_image_model' => env('CLOUDFLARE_AI_CATALOG_IMAGE_MODEL', '@cf/black-forest-labs/flux-2-klein-4b'),
        'text_model' => env('CLOUDFLARE_AI_TEXT_MODEL', '@cf/meta/llama-3.1-8b-instruct-fp8'),
        ...
        'catalog_image_steps' => min(12, max(1, (int) env('CLOUDFLARE_AI_CATALOG_IMAGE_STEPS', 4))),
        ...
        'text_daily_request_budget' => max(1, (int) env('CLOUDFLARE_AI_TEXT_DAILY_REQUEST_BUDGET', 5000)),
        'text_per_user_daily_limit' => max(1, (int) env('CLOUDFLARE_AI_TEXT_USER_DAILY_LIMIT', 250)),
    ],
