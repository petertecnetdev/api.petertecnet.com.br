...
return [
    ...
    // Cookie names are protocol constants because EncryptCookies must exclude
    // exactly these opaque secrets. Renaming them by environment would make
    // rotation/replay checks inconsistent across nodes.
