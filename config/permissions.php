...
return [
    ...
    'operations_view' => ['category'=>'Operações','name'=>'Visualizar operações','description'=>'Permite acompanhar disponibilidade, filas, scheduler, backups e telemetria do ecossistema.'],
    'operations_manage' => ['category'=>'Operações','name'=>'Gerenciar operações','description'=>'Permite executar ações operacionais controladas, como retry de jobs.'],
    'incident_manage' => ['category'=>'Operações','name'=>'Gerenciar incidentes','description'=>'Permite abrir, reconhecer, investigar, atribuir e resolver incidentes.'],
    'security_view' => ['category'=>'Segurança','name'=>'Visualizar segurança','description'=>'Permite acompanhar eventos negados, suspeitos, críticos e erros operacionais.'],
    'finance_view' => ['category'=>'Financeiro','name'=>'Visualizar financeiro','description'=>'Permite visualizar vendas, transações, taxas, repasses, conciliação e saúde financeira.'],
    'finance_manage' => ['category'=>'Financeiro','name'=>'Gerenciar financeiro','description'=>'Permite executar ações administrativas financeiras controladas e acessar dados financeiros sensíveis.'],
    'payout_manage' => ['category'=>'Financeiro','name'=>'Gerenciar repasses','description'=>'Permite administrar repasses e acompanhar obrigações com vendedores e produtores.'],
    'audit_view' => ['category'=>'Governança','name'=>'Visualizar auditoria','description'=>'Permite consultar trilhas de auditoria administrativas e operacionais.'],
    'application_manage' => [
        'category' => 'Aplicações',
