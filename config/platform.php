...
return [
    ...
    'applications' => [
        'cutinapp' => [
            'capabilities' => ['organizations','events','event_tickets','event_community','social','catalog','commerce','payments','payouts','agreements','notifications','moderation','acquisition'],
            'commerce' => [
                ...
                'require_payout_setup_before_sales' => filter_var(env('CUTINAPP_REQUIRE_PAYOUT_SETUP_BEFORE_SALES', true), FILTER_VALIDATE_BOOL),
            ],
            'events' => [
