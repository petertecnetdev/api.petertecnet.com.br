        ...
        <div class="cover-content">
            ...
            <div class="cover-bottom">
                @if($establishment->address)
                    <div class="info-pill">📍
                        {{ $establishment->address }}{{ $establishment->city ? ' - ' . $establishment->city : '' }}</div>
                @endif
                ...
                <div class="item-row avoid-break">
                    ...
                    @else
                        <div class="item-thumb"
                            style="display:flex;align-items:center;justify-content:center;font-size:9px;opacity:.4;">IMG</div>
                    @endif
                    <div class="item-body">
