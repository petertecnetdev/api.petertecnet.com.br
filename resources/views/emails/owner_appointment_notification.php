...
<body>
    <div class="container">
        ...
        <p>Olá, <span class="highlight">proprietário(a)</span>!</p>
        <p>Um novo agendamento foi criado no seu estabelecimento <span class="highlight">{{ $establishmentName }}</span>.</p>

        <p><span class="highlight">👤 Cliente:</span> {{ $customerName }}</p>
        ...
        <p>Você pode acompanhar este agendamento e confirmar sua execução acessando o painel do Rasoio.</p>
