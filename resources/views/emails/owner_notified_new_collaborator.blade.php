        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="color:#FFFFFF;font-size:16px;line-height:1.5;">
              ...
              <p style="margin:0 0 15px;">
                O usuário
                <strong style="color:#00BFFF;">{{ $collaboratorName }}</strong>
                (<a href="mailto:{{ $collaboratorEmail }}" style="color:#00BFFF;text-decoration:none;">{{ $collaboratorEmail }}</a>)
                foi adicionado como colaborador no estabelecimento
              ...
              <p style="margin:0 0 15px;">
                Você pode gerenciar as permissões e visualizar a lista completa
                de colaboradores no painel do estabelecimento.
              </p>

              <p style="margin:0 0 15px;">
                Se precisar ajustar funções ou remover o colaborador, acesse
