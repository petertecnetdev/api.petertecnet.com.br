...
<head>
    ...
    <style>
        ...
        .verification-code {
            ...
            /* Azul claro do triângulo */
            color: #0B1F30;
            /* Contraste forte com o azul claro */
            font-size: 1.5rem;
            font-weight: bold;
            text-align: center;
            padding: 15px;
...
<body>
    <div class="container">
        ...
        <p>
            ...
            comprometida em desenvolver aplicativos móveis e web que agregam valor à sociedade, resolvendo problemas
            reais
