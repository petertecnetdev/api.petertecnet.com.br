...
<head>
  ...
  <title>Você não faz mais parte da equipe</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="color:#FFFFFF;font-size:16px;line-height:1.5;">
              ...
              <p style="margin:0 0 15px;">
                Informamos que você não faz mais parte da equipe de colaboradores do estabelecimento
              ...
              <p style="margin:0 0 15px;">
                Se tiver dúvidas ou precisar de informações adicionais, entre em contato com o proprietário do estabelecimento.
              </p>
            </td>
          </tr>
