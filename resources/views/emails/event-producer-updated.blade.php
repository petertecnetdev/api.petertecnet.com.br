...
<head>
    ...
    <style>
        body,html{margin:0;padding:0}body{background:#081723;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;color:#fff;line-height:1.6}.container{background:#102838;max-width:640px;margin:40px auto;padding:32px;border:1px solid #1bbcff;border-radius:16px;box-shadow:0 12px 32px rgba(0,0,0,.28)}.logo{display:block;margin:0 auto 22px;max-width:130px;height:auto}.eyebrow{text-align:center;text-transform:uppercase;letter-spacing:.12em;font-size:.75rem;font-weight:800;color:#8ce3ff;margin-bottom:8px}h1{font-size:1.8rem;text-align:center;color:#65d7ff;margin:0 0 18px}p{font-size:1rem;color:#f3f8fb}.context{background:#0b1f2d;border:1px solid rgba(101,215,255,.25);padding:16px 18px;border-radius:12px;margin:22px 0}.context p{margin:7px 0}.context strong{color:#65d7ff}.changes{margin:22px 0;padding:0;list-style:none}.changes li{background:#0b1f2d;margin:9px 0;padding:12px 15px;border-radius:10px;border-left:3px solid #1bbcff}.actions{margin:26px 0 10px}.action{display:block;margin:10px auto;padding:14px 20px;border-radius:10px;background:#1bbcff;color:#071621!important;font-weight:800;text-align:center;text-decoration:none}.action.secondary{background:#0b1f2d;color:#65d7ff!important;border:1px solid #1bbcff}.hint{font-size:.9rem;color:#b9cad3}.footer{text-align:center;padding:18px;font-size:.88rem;color:#b9cad3}@media(max-width:680px){.container{margin:18px;padding:22px}h1{font-size:1.45rem}}
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="actions">
            <a href="{{ $eventUrl }}" class="action">Ver evento na {{ $appName }}</a>
