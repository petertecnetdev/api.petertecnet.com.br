...
<body>
    <div class="container">
        ...
        <div class="actions">
            <a href="{{ $eventUrl }}" class="action">{{ $action === 'created' ? 'Ver meu flyer e meu evento' : 'Ver evento na '.$appName }}</a>
            @if(!empty($shareUrl))
