...
| Provider callbacks
|--------------------------------------------------------------------------
| Provider endpoints are infrastructure contracts, not product routes. The
| application context is restored from OAuth state or from the payment row.
*/
...
| Peter Platform API
|--------------------------------------------------------------------------
| Every business capability is reusable and application-scoped. Application
| names only select context; they never select a product-specific controller.
*/
Route::prefix('v1/apps/{application}')
    ...
    ->group(function () {
        ...
        // Shared catalog/discovery capability.
        ...
        // Establishment/item capability used by catalog, services and ordering.
        ...
        // Public organizations and people/social graph.
        ...
        Route::middleware(['auth:api', 'token.version'])->group(function () {
            ...
            // Workforce capability. A team member is a relationship inside the
            // current application/establishment, not an application-specific user.
            Route::post('/team-members', [TeamMemberController::class, 'store']);

            // Generic ordering capability (restaurant/store/service commerce).
            ...
            // Connection/matching capability.
            ...
            // Organizations and event management.
            ...
            // Tickets, event passes and check-in.
            ...
            // Event commerce and payment reconciliation.
            ...
            // Financial identity/payout capability.
            ...
            // Social graph, artist ownership and community.
            ...
            // Shared notifications and moderation.
