...
Route::prefix('auth')->middleware('api')->group(function () {
    ...
    Route::post('/google', GoogleAuthController::class)->name('auth.google');
...
Route::prefix('order-forecast')->middleware(['api', 'auth:api'])->group(function () {
    Route::get('/', [OrderForecastController::class, 'index']);
    Route::post('/generate', [OrderForecastController::class, 'generate']);
});
