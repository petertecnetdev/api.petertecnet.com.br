...
return new class extends Migration {
    ...
    {
        if (! Schema::hasTable('payflow_opportunities')) {
        ...
        if (! Schema::hasTable('payflow_proposals')) {
        ...
        if (! Schema::hasTable('payflow_charges')) {
        ...
        if (! Schema::hasTable('payflow_agent_activities')) {
