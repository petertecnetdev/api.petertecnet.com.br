...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $applications = (array) config('platform.applications', []);

        foreach ($applications as $slug => $definition) {
    ...
    {
        // Intentionally non-destructive: the previous persisted capability list
        // cannot be reconstructed safely after reconciliation.
    }
