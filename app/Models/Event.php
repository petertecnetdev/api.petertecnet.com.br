...
class Event extends Model
{
    ...
    protected static function booted(): void
    {
        static::saving(function (Event $event) {
            ...
            if ($event->event_format === 'online' && ! $event->online_url) throw ValidationException::withMessages(['online_url'=>['Informe a URL de acesso do evento online.']]);
            if ($event->event_format === 'hybrid' && ! $event->online_url) throw ValidationException::withMessages(['online_url'=>['Informe a URL da parte online do evento híbrido.']]);
