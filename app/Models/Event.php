...
class Event extends Model
{
    ...
    protected static function booted(): void
    {
        ...
        static::saved(function (Event $event) {
            ...
            $materialFields = ['title','description','category','image','opening_media_type','opening_media','event_format','address','address_number','neighborhood','address_complement','formatted_address','google_maps_url','online_platform','online_url','online_instructions','start_date','end_date','venue','city','uf','cep','max_attendees','is_cancelled'];
            $changed = collect(array_keys($event->getChanges()))->intersect($materialFields)->values(); if ($changed->isEmpty()) return;
            $labels = ['title'=>'nome','description'=>'descrição','category'=>'categoria','image'=>'imagem','opening_media_type'=>'mídia de abertura','opening_media'=>'mídia de abertura','event_format'=>'formato','address'=>'endereço','address_number'=>'endereço','neighborhood'=>'endereço','address_complement'=>'endereço','formatted_address'=>'endereço','google_maps_url'=>'localização','online_platform'=>'acesso online','online_url'=>'acesso online','online_instructions'=>'acesso online','start_date'=>'horário','end_date'=>'horário','venue'=>'local','city'=>'cidade','uf'=>'estado','cep'=>'endereço','max_attendees'=>'capacidade','is_cancelled'=>'status'];
