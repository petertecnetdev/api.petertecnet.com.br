...
class Event extends Model
{
    ...
    public function establishment(){return $this->belongsTo(Establishment::class,'establishment_id');}
    /** @deprecated Use establishment(). */
    public function production(){return $this->belongsTo(Establishment::class,'establishment_id')->where('type','production');}
    ...
    /** @deprecated Compatibility accessor while old notification payloads are retired. */
    public function getProductionIdAttribute(): ?int
    {
        $id = $this->getAttributeFromArray('establishment_id');
