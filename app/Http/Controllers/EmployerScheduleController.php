    ...
    }public function availableTimes(Request $request)
{
    try {
        ...
        // 🔹 Carrega os horários de trabalho do colaborador
        ...
        // 🔹 Busca os agendamentos no banco (UTC)
        ...
        // 🔹 Converte todos para timezone do Brasil
        $occupied = [];
