...
class PlatOrderingSettingsController extends Controller
{
    ...
    public function update(Request $request, int $establishment): JsonResponse
    {
        ...
        abort_if(in_array('pix', $methods, true) && ! $mercadoPagoConfigured && $pixKey === '', 422, 'Para aceitar Pix, configure o Mercado Pago na API ou informe uma chave Pix do estabelecimento.');
