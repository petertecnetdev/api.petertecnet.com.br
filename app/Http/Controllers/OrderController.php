...
public function listByEntity(string $identifier)
{
    try {
        ...
        return $this->jsonUtf8([
            'message' => 'Dados para cria̤̣o de pedido carregados com sucesso.',
            'establishment' => [
                'id' => $establishment->id,
                'name' => $establishment->name,
                'fantasy' => $establishment->fantasy,
        ...
        return $this->jsonUtf8([
            'error' => 'Erro ao carregar dados para cria̤̣o do pedido.',
...
public function listOrdersByEntity(string $identifier)
{
    try {
        ...
        if (!$establishment) {
            return $this->jsonUtf8(['error' => 'Estabelecimento ṇo encontrado.'], 404);
        }
        ...
        Log::error('Order.listOrdersByEntity error', [
            'identifier' => $identifier,
            'error' => $e->getMessage(),
        ]);
