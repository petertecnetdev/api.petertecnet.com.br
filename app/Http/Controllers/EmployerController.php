        ...
        try {
            ...
            if (!$targetUser) {
                ...
                return response()->json([
                    ...
                    'details' => 'Não existe usuário cadastrado com este email. '
                        . 'Peça que o colaborador se registre antes ou verifique o email correto.'
                ], 404);
            }
            ...
            // 7) Envio de e-mail ao proprietário
            try {
                Mail::to($user->email)
            ...
            // Retorna erros de validação (incluindo email inválido)
