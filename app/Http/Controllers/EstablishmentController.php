    ...
    public function generatePdf($slug)
    {
        ...
        <body>';
            ...
            if ($establishment->address)
                $html .= '<div class="info">' . e($establishment->address) . '</div>';
            if ($establishment->phone)
                $html .= '<div class="info">WhatsApp: ' . e($establishment->phone) . '</div>';
            if ($establishment->instagram_url)
                $html .= '<div class="info">Instagram: ' . e($establishment->instagram_url) . '</div>';
