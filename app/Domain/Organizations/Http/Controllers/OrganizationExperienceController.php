...
{
    public function __construct(private readonly OrganizationExperienceService $experience) {}

    public function publicExperience(Request $request, string $slug)
    {
        return response()->json(
            $this->experience->publicExperience($slug, $request->bearerToken())
        );
    }
    ...
    {
        return response()->json(
            $this->experience->workspace($request->user(), $id)
        );
    }
    ...
    public function updateProfile(Request $request, int $id)
    {
        ...
        return response()->json([
            ...
            'organization' => $this->experience->updateProfile($request->user(), $id, $data),
        ]);
    }
}
