...
final class RecoveryProminenceExperimentEconomics
{
    ...
    public function summarize(iterable $interactions, iterable $orders, string $experiment): array
    {
        ...
        $comparison['rollout_readiness'] = $this->rolloutReadiness($comparison);
    ...
    /** @return array<string, mixed> */
    private function rolloutReadiness(array $comparison): array
    {
        ...
        $conversionGuardrail = (bool) data_get($decision, 'confidence.paid_conversion_guardrail_satisfied', false);
        $contributionGuardrail = data_get($decision, 'guardrails.platform_contribution_positive') === true;
