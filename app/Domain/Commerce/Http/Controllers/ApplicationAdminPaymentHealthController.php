...
final class ApplicationAdminPaymentHealthController extends Controller
{
    ...
    public function __invoke(): JsonResponse
    {
        ...
        $current['diagnosis'] = $this->diagnoseCurrent($current);
        $current['incidents'] = $this->diagnoseIncidents(
    ...
    private function diagnoseCurrent(array $current): array
    {
    ...
    private function diagnoseIncidents(array $incidents): array
    {
